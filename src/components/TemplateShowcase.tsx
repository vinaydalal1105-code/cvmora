      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="relative flex items-center justify-center min-h-[580px]">
          <button
            type="button"
            onClick={goPrev}
            className="absolute left-2 sm:left-4 z-10 w-12 h-12 rounded-full bg-white shadow-lg border border-[#e7e5e4] text-[#1c1917] hover:border-[#f97316]/50 hover:text-[#f97316] flex items-center justify-center transition-colors"
          ...
          <div className="flex flex-col items-center px-4 w-full max-w-[580px] min-w-[400px] flex-shrink-0">
            <div className="text-[#1c1917] font-bold text-xl mb-1">
              {current.name}
            </div>
            <p className="text-[#78716c] text-sm mb-6">
              {current.users ? `${current.users} chose this template` : "500+ users chose this template"}
            </p>
            <div className="relative w-full flex justify-center min-h-[680px]">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="absolute inset-0 flex flex-col items-center justify-start w-full"
                >
                  <div
                    className="flex justify-center w-full"
                    style={{ transform: "scale(1.28)", transformOrigin: "top center" }}
                  >
                    <TemplateCard
                      template={current}
                      variant="hero"
                  ...
                  <Link
                    to="/builder"
                    className="mt-8 w-full max-w-[320px] py-3 rounded-lg bg-[#BFED8D] text-[#1c1917] text-center text-[13px] font-semibold border border-[#a8e070] hover:bg-[#b0e87d] transition-colors"
                  >
                    Use this template
                  </Link>
                </motion.div>
          ...
          <button
            type="button"
            onClick={goNext}
            className="absolute right-2 sm:right-4 z-10 w-12 h-12 rounded-full bg-white shadow-lg border border-[#e7e5e4] text-[#1c1917] hover:border-[#f97316]/50 hover:text-[#f97316] flex items-center justify-center transition-colors"
