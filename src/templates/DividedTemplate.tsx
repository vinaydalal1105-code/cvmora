...
/** Strong horizontal divider under header; bold section titles; clean single column. */
export function DividedTemplate({ data, accentColor }: { data: ResumeData; accentColor?: string }) {
  ...
  return (
    <div className="divided-template bg-white text-[#1c1c1c] pt-10 px-8 pb-6 min-h-0 max-w-[210mm] mx-auto font-sans text-sm">
