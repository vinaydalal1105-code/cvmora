    ...
    <div className="clean-template bg-white text-[#1c1c1c] pt-10 px-8 pb-8 min-h-[842px] max-w-[210mm] mx-auto font-sans text-[13px] overflow-visible">
      <header className="mb-4 pb-3 border-b border-[#e5e7eb] flex gap-5 items-start">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-0 text-[12px] text-[#6b7280]">
            {contact.email || contact.phone || contact.address?.trim() || contact.location || contact.website || contact.linkedin ? (
              <>
                ...
                {contact.website && <a href={contact.website} className="text-[#2563eb] underline">Website</a>}
                {contact.linkedin && <a href={contact.linkedin} className="text-[#2563eb] underline">LinkedIn</a>}
              </>
            ) : (
