...
export function Landing() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section
        className="relative pt-28 sm:pt-28 pb-32 sm:pb-40 px-6 sm:px-6 min-h-0 sm:min-h-[85vh] sm:min-h-[85dvh] flex items-center"
        style={{
          background: 'linear-gradient(180deg, #fef7f0 0%, #ffedd5 12%, #ffe4c4 25%, #f5e6dc 40%, #e8f0f4 55%, #dceef5 70%, #d4ebf7 85%, #e0f2fe 100%)',
        }}
      >
        <div className="max-w-[1100px] mx-auto relative w-full flex flex-col lg:flex-row items-center gap-20 sm:gap-12 lg:gap-20">
          <div className="flex-1 text-center lg:text-left max-w-lg mx-auto lg:mx-0 w-full">
            <h1 className="text-[1.625rem] sm:text-5xl lg:text-[3.25rem] font-bold leading-[1.35] sm:leading-[1.12] tracking-tight pt-4 text-[#1c1917]">
              This resume builder gets you{' '}
              <span className="text-[#f97316]">hired faster</span>
            </h1>
            <p className="text-[15px] sm:text-xl text-[#57534e] leading-relaxed max-w-sm sm:max-w-md mx-auto lg:mx-0 pt-8 sm:pt-6" style={{ lineHeight: 1.85 }}>
              Only 2% of resumes win. Yours will be one of them.
            </p>
            <div className="flex flex-col gap-8 sm:gap-4 pt-10 sm:pt-8 max-w-xs sm:max-w-none mx-auto lg:mx-0 sm:flex-row sm:flex-wrap sm:justify-center lg:justify-start">
              <Link
            ...
            <div className="flex items-center justify-center lg:justify-start gap-6 text-[13px] sm:text-sm text-[#57534e] pt-14 sm:pt-10">
